...
export const metadata: Metadata = {
  title: "BizMatch AI | Pak Angels Hackathon",
        ...
        <div className="bg-obsidian border-t border-white/10 py-4 px-6 mt-auto">
          <div className="max-w-7xl mx-auto flex items-center justify-center text-center">
            <p className="text-xs text-slate-500 max-w-3xl">
              <strong className="text-slate-400">BizMatch AI is a decision-support platform.</strong> Recommendations provide advisory trade-off analysis; final hiring choices remain with the founder. 
            </p>
          </div>
        </div>
      </body>
