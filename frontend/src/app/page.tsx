      ...
      <header className="border-b border-white/10 bg-obsidian/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center font-bold text-obsidian">B</div>
            <span className="font-semibold text-lg tracking-tight text-white">BizMatch AI</span>
          </div>
